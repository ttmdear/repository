...
CMakeFiles/upload:
	avr-objcopy -j .text -j .data -O ihex cmake_sketch.bin cmake_sketch.hex
	avrdude -p atmega328p -c avrisp -U flash:w:cmake_sketch.hex:i -F -P /dev/ttyACM0 -C /opt/arduino-1.8.9/hardware/tools/avr/etc/avrdude.conf
