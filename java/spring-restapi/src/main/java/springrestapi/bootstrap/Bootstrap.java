package springrestapi.bootstrap;
...
import springrestapi.domain.user.locations.Cordinate;
...
public class Bootstrap implements CommandLineRunner {
    public final static String USER_JOHN_ID = UUID.randomUUID().toString();
    public final static String SIMPLE_EVENT_ID = UUID.randomUUID().toString();
    ...
    public Bootstrap(UserRepository userRepository, AddressRepository addressRepository,
        PictureRepository pictureRepository, EventRepository eventRepository) {
    ...
    private void initData() {
        ...
        // Some event
        if (eventRepository.count().block() == 0) {
            Event eventA = new Event();
            eventA.setId(SIMPLE_EVENT_ID);
            eventA.setMessage("Simple event");

            eventRepository.save(eventA).block();
        }
    }
